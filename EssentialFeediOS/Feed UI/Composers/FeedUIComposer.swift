...
public final class FeedUIComposer {
    ...
    public static func feedComposedWith(feedLoader: FeedLoader, imageLoader: FeedImageDataLoader) -> FeedViewController {
        ...
        let presentationAdapter = FeedLoaderPressentationAdapter(feedLoader: feedLoader, presenter: presenter)
...
private final class FeedLoaderPressentationAdapter: FeedRefreshViewControllerDelegate {
