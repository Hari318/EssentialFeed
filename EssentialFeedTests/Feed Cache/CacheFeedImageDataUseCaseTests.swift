...
class CacheFeedImageDataUseCaseTests: XCTestCase {
    ...
    func test_saveImageDataFromURL_doesNotDeliverResultAfterSUTInstanceHasBeenDeallocated() {
        ...
        var result = [LocalFeedImageDataLoader.SaveResult]()
        sut?.save(anyData(), for: anyURL()) { result.append($0) }
        
        sut = nil
        store.completeInsertionSuccessfully()
        
        XCTAssertTrue(result.isEmpty, "Expected no received results after instance has been deallocated")
    }
